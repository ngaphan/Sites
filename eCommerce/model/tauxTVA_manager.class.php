...
class TauxTVAManager extends Model
{
    ...
    {
        // On prépare notre requête SQL
        $query = "INSERT INTO tauxTVAs (idTauxTVA,refTauxTVA, valeurTauxTVA,) VALUES (:idTauxTVA,:refTauxTVA, :valeurTauxTVA)";
    ...
    {
        // On prépare notre requête SQL
        $query = "DELETE FROM tauxTVAs WHERE idTauxTVA = :idTauxTVA";
    ...
    public function create($idTauxTVA)
    {
        ...
        {
            // On prépare notre requête SQL
            $query = "SELECT * FROM tauxTVAs WHERE idTauxTVA = :idTauxTVA";
            ...
            $tauxTVAManagerObj = new TauxTVA($tauxTVAManagerArray['idTauxTVA'],
