...
class ProduitManager extends Model
{
    ...
    public function listAll()
    {
        ...
        $query = "SELECT * FROM produits ORDER BY idProduit";
    ...
    /**
     * Supprime une Produit de la BDD à partir de son identifiant
     *
    ...
    public function calcStockProduits($idProduit ,$quantitéProduitsCommandes)
    {
        ...
        $nouveauStock = $ancienStock -$quantitéProduitsCommandes ;
        return $nouveauStock ;
    }
