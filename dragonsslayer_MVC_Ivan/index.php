...
// - classes "filles"
require_once 'model/character_manager.class.php';
require_once 'model/character.class.php';
require_once 'model/weapon_manager.class.php';
require_once 'model/weapon.class.php';
require_once 'model/dragon_manager.class.php';
require_once 'model/dragon.class.php';
...
/*
	...
	Ex: index.php?menu=signup affichera 'view/signup.html' grâce à l'include 'view/' . $menu . '.phtml';
 */
