...
if($menu==='home')
{
    ...
    {
        $userObj = $userManager->create($_SESSION['username'],$_SESSION['mdp']) ;
        $_SESSION['selectedUserObj'] = serialize($userObj) ;
        unset($_SESSION['username'],$_SESSION['mdp']) ;
        echo $_SESSION['selectedUserObj'] ;
    }

    if(isset($_SESSION['selectedUserObj']))
    {
        $selectedUserObj = unserialize($_SESSION['selectedUserObj']);
        $addedUserObj= $userManager->add($selectedUserObj);
    }
